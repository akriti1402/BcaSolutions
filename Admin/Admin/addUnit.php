                            ...
                            <form method="POST">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="uname" id="uname" class="form-control" placeholder="Semester Name">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label">Unit Thumbnail</label>
                                        <input type="file" id="uthumbnail" name="uthumbnail" class="form-control" placeholder="Semester Thumbnail">
                                    </div>
                                </div>
                                ...
                                <div class="settings-inner-blk p-0">
                                    ...
                                    <div class="comman-space pb-0">
                                        <div class="settings-tickets-blk course-instruct-blk table-responsive">
                                            <table class="table table-nowrap mb-0" id="UnitList">

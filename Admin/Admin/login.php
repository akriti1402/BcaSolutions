...
if (isset($_POST['submit'])) {
    ...
    $signin_sql = "SELECT * FROM `signup` WHERE `email` = '$email' AND `password`='$password'";
                ...
                <div class="owl-carousel login-slide owl-theme">
                    <div class="welcome-login">
                        <div class="login-banner">
                            <img src="../../Images/newLogoScap.png" style="height:15rem;width:auto;" class="img-fluid" alt="Logo">
                        </div>
